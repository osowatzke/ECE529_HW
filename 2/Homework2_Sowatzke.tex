...
\begin{document}
	...
	\begin{enumerate}[nolistsep]
		...
		\item[5.] Study the Intro-MATLAB document at D2L\textgreater Contents\textgreater MATLAB. Use MATLAB (or other software) to plot the semilogarithmic magnitude frequency response of the following filter. Submit your code as a separate file that the grader can run.
		...
		\begin{figure}[H]				
			\centerline{\fbox{\includegraphics[width=0.5\textwidth]{prob5_mag_freq_response.png}}}
