...
\begin{document}
	...
	\begin{enumerate}[nolistsep]
		...
		\item[5.] Study the Intro-MATLAB document at D2L>Contents>MATLAB. Use MATLAB (or other software) to plot the semilogarithmic magnitude frequency response of the following filter. Submit your code as a separate file that the grader can run.
