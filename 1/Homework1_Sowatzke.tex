...
\begin{document}
	...
	\begin{enumerate}[nolistsep]
		...
		\begin{figure}[H]		\centerline{\fbox{\includegraphics[width=0.5\textwidth]{p2.21_problem_statement.png}}}
		...
		\begin{enumerate}[nolistsep]
			...
			\begin{figure}[H]				
			\centerline{\fbox{\includegraphics[width=0.5\textwidth]{p2.21_c.png}}}
		...
		\end{figure} \break
			...
			\begin{figure}[H]
			\centerline{\fbox{\includegraphics[width=0.5\textwidth]{p2.21_e_x_nm1.png}}}
		...
		\end{figure}
			...
			\begin{figure}[H]
			\centerline{\fbox{\includegraphics[width=0.5\textwidth]{p2.21_e_delta_nm3.png}}}
		...
		\begin{figure}[H]
			\centerline{\fbox{\includegraphics[width=0.5\textwidth]{p2.21_e.png}}}
		...
		\item[2.28] Four input-output pairs of a particular system $S$ are specified in Figure P.28-1
			...
			\begin{figure}[H]
			\centerline{\fbox{\includegraphics[width=0.5\textwidth]{p2.28_problem_statement.png}}}
