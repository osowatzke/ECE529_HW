...
the outermost (largest magnitude) finite pole.
				...
				\item[(b)] Determine if the system is stable or not.
				 ...
				 \item[(d)] Use a partial fraction expansion to determine the impulse response $h[n]$.
				 	...
				 	For partial fraction expansion to work, the numerator degree of $H(z)$ must be less than the denominator degree. Because this is not the case for $H(z)$, we must first rewrite $H(z)$ in a form that satisfies this criteria.
				 	
				 	\begin{equation*}
				 		H(z) = \frac{4 + 0.25z^{-1}}{(1-0.25z^{-1})(1 + 0.5z^{-1})} - \frac{0.5z^{-2}}{(1-0.25z^{-1})(1 + 0.5z^{-1})}
				 	\end{equation*}
				 	
				 	$H(z) = H_1(z) - H_2(z)$
				 	
				 	Note that the numerator degree of $H_1(z)$ is less than the denominator degree, so we can apply partial fraction expansion to $H_1(z)$.
				 	
				 	\begin{equation*}
				 		H_1(z) = \frac{4 + 0.25z^{-1}}{(1-0.25z^{-1})(1 + 0.5z^{-1})} = \frac{A}{1-0.25z^{-1}} + \frac{B}{1 + 0.5z^{-1}}
				 	\end{equation*}
				 	
				 	\begin{equation*}
				 		A = \left.\frac{4 + 0.25z^{-1}}{1 + 0.5z^{-1}}\right\vert_{z = 0.25} = \frac{4 + 0.25(4)}{1 + 0.5(4)} = \frac{5}{3}
				 	\end{equation*}
				 	
				 	\begin{equation*}
				 		B = \left.\frac{4 + 0.25z^{-1}}{1 - 0.25z^{-1}}\right\vert_{z = -0.5} = \frac{4 + 0.25(-2)}{1 - 0.25(-2)} = \frac{3.5}{1.5} = \frac{7}{3}
				 	\end{equation*}
				 	
				 	\begin{equation*}
				 		H_1(z) = \frac{5/3}{1 - 0.25z^{-1}} + \frac{7/3}{1 + 0.5z^{-1}}
				 	\end{equation*}
				 	
				 	We can take the inverse z-transform of $H_1(z)$ using a table of z-transform pairs to obtain $h_1[n]$.
				 	
				 	\begin{equation*}
				 		h_1[n] = \frac{5}{3}\left(\frac{1}{4}\right)^nu[n] + \frac{7}{3}\left(-\frac{1}{2}\right)^nu[n]
				 	\end{equation*}
				 		
				 	Note that the numerator degree of $H_2(z)$ is still greater than the denominator degree of $H_2(z)$, so we cannot apply partial fraction expansion directly. However, we can perform a partial fraction on $H_2(z)z^2$.
				 	
				 	\begin{equation*}
				 		H_2(z)z^2 = \frac{0.5}{(1-0.25z^{-1})(1 + 0.5z^{-1})} = \frac{A}{1-0.25z^{-1}} + \frac{B}{1 + 0.5z^{-1}}
				 	\end{equation*}
				 	
				 	\begin{equation*}
				 		A = \left.\frac{0.5}{1 + 0.5z^{-1}}\right\vert_{z = 0.25} = \frac{0.5}{1 + 0.5(4)} = \frac{0.5}{3} = \frac{1}{6}
				 	\end{equation*}
				 	
				 	\begin{equation*}
				 		B = \left.\frac{0.5}{1 - 0.25z^{-1}}\right\vert_{z = -0.5} = \frac{0.5}{1 - 0.25(-2)} = \frac{0.5}{1.5} = \frac{1}{3}
				 	\end{equation*}
				 	
				 	\begin{equation*}
				 		H_2(z)z^2 = \frac{1/6}{1 - 0.25z^{-1}} + \frac{1/3}{1 + 0.5z^{-1}}
				 	\end{equation*}
				 	
				 	\begin{equation*}
				 		\Rightarrow H_2(z) = \frac{(1/6)z^{-2}}{1 - 0.25z^{-1}} + \frac{(1/3)z^{-2}}{1 + 0.5z^{-1}}
				 	\end{equation*}
				 	
				 	We can take the inverse z-transform of $H_2(z)$ using a table of z-transform pairs and the time-delay theorem.
				 	
				 	\begin{equation*}
				 		h_2[n] = \frac{1}{6}\left(\frac{1}{4}\right)^{n-2}u[n-2] + \frac{1}{3}\left(-\frac{1}{2}\right)^{n-2}u[n-2]
				 	\end{equation*}
