	...
	\begin{enumerate}[nolistsep]
		\item Design a discrete-time second-order Butterworth lowpass filter with cutoff frequency equivalent to $f_c = 1.6 \text{kHz}$. Assume the ADC sampling frequency is $f_s = 8 \text{kHz}$. Use the impulse invariance method with $T_d = 1$.
			...
			\begin{enumerate}[nolistsep]
				...
				\begin{equation*}
					= \left(\frac{-j\pi\sqrt{2}}{5} +  \frac{j\pi\sqrt{2}}{5}\right) e^{-\frac{0.4{\pi}t}{\sqrt{2}}} + \frac{\pi\sqrt{2}}{5}\left(-je^{\frac{j0.4{\pi}t}{\sqrt{2}}} + je^{-\frac{j0.4{\pi}t}{\sqrt{2}}}\right)
				\end{equation*}
				
				\begin{equation*}
					= \frac{2\pi\sqrt{2}}{5}\left(\frac{e^{\frac{j0.4{\pi}t}{\sqrt{2}}} - e^{-\frac{j0.4{\pi}t}{\sqrt{2}}}}{j2}\right) = \frac{2\pi\sqrt{2}}{5}\sin{\left(\frac{0.4{\pi}t}{\sqrt{2}}\right)}
				\end{equation*}
			\end{enumerate}
	\end{enumerate}
\end{document}
