...
\begin{document}
	...
	\begin{enumerate}
		...
		\texttt{firpm} function. Design an FIR LPF with length 17, passband cutoff frequency $\omega = 0.37\pi$, and stopband cutoff frequency $\omega = 0.71\pi$ using the \texttt{firpm} function. Compare to the result in Problem 1.
